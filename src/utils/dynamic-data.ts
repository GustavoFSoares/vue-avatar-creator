...
//   WidgetType,
// } from '../enums'
// import { getAvatarFace } from './constant'
...
//   [WidgetType.Face]: {
//     ...Object.keys(FaceShape).reduce((amount, current) => {
//       amount[FaceShape[current]] = () =>
//         getAvatarFace(FaceShape[current], FaceColors[current], 'widgets')
...
//     ...Object.keys(FaceShape).reduce((amount, current) => {
//       amount[FaceShape[current]] = () =>
//         getAvatarFace(FaceShape[current], FaceColors[current], 'preview')
